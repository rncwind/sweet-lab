...
// Model for our project data type.

export class Project {
    id: number | undefined; // Something that is either a number, or undefiend.
    name: string = '';
    description: string = '';
    imageUrl: string = '';
    ...
    constructor(initializer?: any) {
        // If we don't have an initializer, presumably default everything.
        if (!initializer) return;

        // Otherwise do our best to set each value.
